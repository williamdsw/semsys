...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] PUBLIC_MATCHERS_GET = { "/v1/public/**" };
	private static final String[] PUBLIC_MATCHERS_POST = { "/v1/public/**" };
	private static final String[] SWAGGER_MATCHERS_POST = { "/v2/api-docs", "/configuration/ui",
